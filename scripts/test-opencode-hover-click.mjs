#!/usr/bin/env node
// Regression test for the opencode-go-usage hover/click race.
//
...
const SOURCE_PATH = 'extensions/opencode-go-usage/assets/opencode-go-usage.js';
...
function createHarness() {
  ...
  vm.runInContext(source, sandbox, { filename: 'opencode-go-usage.js' });

  const chip = left.children.find((c) => c.id === 'btnOpenCodeUsage');
